<%-- 
    Document   : adminlogin
    Created on : Jul 10, 2014, 7:44:09 PM
    Author     : EMachines
--%>
...
<html>
    <head>
     ...
     <body style="background-image: url('438369.jpg')"><%!String str1=null;
        String str2=null;%>
            <h1 style="background-image: url('banner.jpg')" width="10" ><b><center><font color="#ffff00">Admin Login</font></center></b></h1>
        <a href="login.jsp" align="left"><img src="20140708160226.png" height="80px" width="150px"/></a><center><img src="20140710194630.jpg"/><br><br>
